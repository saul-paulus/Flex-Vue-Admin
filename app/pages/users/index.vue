  ...
  <div class="container-fluid py-2">
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-12 col-md-6 col-xl-3">
        <div
          class="card border border-light shadow-sm h-100 bg-white"
    ...
    >
      <div class="card-header bg-white border-bottom p-3">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
          <!-- Tabs/Pills -->
          <ul
            class="nav nav-pills custom-pills mb-0"
            style="gap: 5px;"
          >
            <li class="nav-item">
              <a
              ...
              >
                All <span
                  class="badge bg-secondary-subtle text-secondary rounded-pill ms-1"
          ...
          <div class="d-flex align-items-center gap-2">
            <div
              class="input-group input-group-sm border rounded bg-white shadow-sm"
              style="width:250px;"
            >
        ...
        <table class="table table-hover align-middle mb-0 text-nowrap">
          ...
          >
            <tr>
              <th
                scope="col"
                class="py-3 ps-4 border-0 fw-bold"
                style="width: 40px; background-color: var(--zebra);"
              >
                <input
              ...
              <th
                scope="col"
                class="py-3 pe-4 border-0 fw-bold text-end"
                style="background-color: var(--zebra);"
              >
                ACTIONS
              </th>
          ...
          <tbody class="border-top-0">
            ...
            >
              ...
              <td
                class="py-3"
                style="font-size: 0.85rem; color: var(--secondary-color-text)"
              >
                {{ user.lastActive }}
              </td>
              <td
      ...
      >
        ...
        <nav aria-label="Page navigation">
          <ul class="pagination pagination-sm mb-0 gap-1">
            ...
            <li class="page-item">
              <a
                class="page-link border-0 rounded text-muted text-hover-dark bg-transparent"
                href="#"
              >2</a>
            </li>
            <li class="page-item">
