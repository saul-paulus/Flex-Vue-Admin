...
const permissions = ref([
  ...
  },
  {
    ...
    items: [
      { name: 'Pages', view: true, create: true, edit: true, delete: true, all: true },
      { name: 'Blog Posts', view: true, create: true, edit: true, delete: true, all: true },
      { name: 'Media Library', view: true, create: true, edit: true, delete: true, all: true },
    ],
  },
  {
    category: 'E-commerce',
    icon: 'cart3',
    items: [
      { name: 'Products', view: true, create: true, edit: true, delete: true, all: true },
      { name: 'Orders', view: true, create: true, edit: true, delete: true, all: true },
      { name: 'Customers', view: true, create: true, edit: true, delete: true, all: true },
      { name: 'Coupons', view: true, create: true, edit: true, delete: true, all: true },
    ],
  },
  {
          ...
          <div class="table-responsive">
            <table class="table align-middle mb-0 text-nowrap">
              ...
              <tbody class="border-top-0">
                <template
                  v-for="(group, gIndex) in permissions"
                  :key="gIndex"
                >
                  <!-- Category Row -->
                  <tr class="bg-light">
                  ...
                  >
                    ...
                    <td class="text-center py-3">
                      <i
                        v-if="item.view"
                        class="bi bi-check-circle-fill text-teal fs-5"
                      />
                      <span
                        v-else-if="item.v_dash"
        ...
        >
          <div class="card-header bg-white border-bottom p-4 pb-3 d-flex justify-content-between align-items-center">
            <h6
              ...
              style="color: var(--title-color)"
            >
              Users with {{ activeRole.name }} Role
            </h6>
            <span
              class="text-muted"
              style="font-size: 0.8rem;"
